...
- `结束归档`：把本次讨论压缩写入 `context/sessions/YYYY-MM-DD-<主题名>.md`，并同步更新 `context/state.md`、`context/decisions.md`、`context/open_questions.md`，最后用 3 行总结结论/下一步/未决问题；然后按下面「结束归档后的 Git」约定提交并推送。
